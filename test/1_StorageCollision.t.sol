...
contract StorageCollisionTest is Test {
    ...
    function testCollision() public {
        ...
        assertEq(corruptedImplementation, address(uint160(9999)), "Implementation corrupted to 9999!");

        // The proxy is now completely broken
        assertFalse(corruptedImplementation == address(logicV2), "Implementation should NOT be V2 anymore");
